...
--
-- Host: localhost
-- Generation Time: Feb 28, 2014 at 01:06 PM
...
CREATE TABLE IF NOT EXISTS `looks` (
  ...
  `like_count` tinyint(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`)
...
INSERT INTO `looks` (`Id`, `caption_name`, `order_id`, `user_id`, `product_id`, `image`, `status`, `created`, `category_id`, `like_count`) VALUES
(52, 'New look for this product', 1, 2, 2, '53105901-1458-4e13-b8e9-100c408d8133.jpg', 0, '2014-02-28 09:38:09', NULL, 0),
(53, 'The testing look is uploading', 1, 2, 2, '53107426-dd38-4ab1-b07d-100c408d8133.png', 0, '2014-02-28 11:33:59', NULL, 0),
(55, 'asdcfad as sdg f hghjghjhjhf dfgdfgsdasc', 1, 2, 40, '53107fc4-d0cc-4cd8-81cf-100c408d8133.jpg', 0, '2014-02-28 12:23:34', NULL, 0),
(56, 'asdcfad as sdg f hghjgcdfghjhjhf dfgdfgsdasc', 4, 2, 2, '5310803c-7248-4efe-a327-100c408d8133.jpg', 0, '2014-02-28 12:25:34', NULL, 0);
...
(1, 10001, 40, 2, '2014-02-06 00:00:00'),
(2, 1002, 90, 1, '2014-02-20 00:00:00'),
(4, 10004, 2, 2, '2014-02-19 00:00:00'),
(5, 1006, 40, 2, '2014-02-12 00:00:00');
