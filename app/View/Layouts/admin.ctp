...
<nav id="nav">
	<ul class="menu">
		...
		<li><?php echo $this->Html->link('Reports', array('controller' => 'Admin', 'action' => 'view_products')); ?>
			<ul>
				<li class=""><?php echo $this->Html->link('Commission', array('controller' => 'Admin', 'action' => 'view_commission')); ?></li>
