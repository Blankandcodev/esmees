				...
				<div class="pr_1">
					<div class="pr_left">
						<div class="pr_img"><?php echo $this->Html->image('Users/home/'.$user['image']);?></div>
							<div class="pr_mn">
							<div class="pr_txt"><span class="labl">Username:</span><span><?php echo  $user['name']; ?></span></div>
							</div>
								<div class="pr_mn">
									<div class="pr_txt"><span class="labl"><i>Follower:</span></i><span>999,999,999</span></div>
								</div>
									<div class="pr_mn">
