...
<?php echo $this->Form->create('User', array('class'=>'cform')); ?>
    ...
    <?php
        ...
        echo $this->Form->input('address', array('label'=>'Address Line 1', 'maxLength'=>'250', 'type'=>'textarea', 'class'=>'required'));
		echo $this->Form->input('address1', array('label'=>'Address Line 2', 'maxLength'=>'250', 'type'=>'textarea', 'class'=>'required'));
