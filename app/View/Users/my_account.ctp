        ...
        <div class="container">
						...
						<div class="ma_right">
							<div class="mc_prf">
								...
								<div class="ac_left">
								   <div class="ac_txt_main"><div class="ac_hd">Account Info<span>  <?php echo $this->Html->link('Edit', array('controller'=>'Users', 'action'=>'user_profile',$user['id']));?> </span></div></div>
								   
									   <div class="account_sec">
										 <ul>
										    <li>Email Address : <?php echo  $user['username']; ?></li>
										   <li>Full Name:  <?php echo  $user['name']; ?> </li>
										   ...
										   <li>Country:  <?php echo  $user['country']; ?></li>
									   			...
									   			<div class="ac_rt_txt"><?php echo $this->Html->link('ChangePassword', array('controller'=>'Users', 'action'=>'password',$user['id']));?> </div>
								   					...
								   					<div class="ac_txt2">
														<div class="account_sec2">
															...
															<div class="account_sec3_txt"><span class="labl">Likes :</span> <span><?php echo $likeCounts ?></span></div>
														 	...
														 	<div class="account_sec3">
															<div class="account_sec3_txt"><span class="labl">Commission :</span> <span>$999,999</span></div>
						                                 </div>
													</div>	 
                         </div>
						...
						<?php echo $this->Html->link($this->Html->image($like['Product']['image_url'], array( 'alt' => 'No Image')), array(
                          ...
                          <div class="list_txt">
						     <div class="txt5"><?php echo $like['Product']['name']; ?></div>
							    <div class="ul_txt"><span class="labl"> <a href="<?php echo $this->Html->url(array('controller'=>'Users', 'action'=>'followers', $like['Like']['user_id']),true) ?>">
